...
- 🕵️ APT and threat research
- 🌐 Malicious domains and URLs
- 🔎 Indicators of compromise
- 🧩 Obfuscation and execution techniques
- ⚙️ Persistence and system modification techniques
...
- 🔎 Similarities with known campaigns
...
<p align="center">
  <a href="https://ko-fi.com/sakai38666">
    <img
      ...
      height="44"
      alt="Support my research on Ko-fi">
  </a>
</p>
...
<p align="center">
  <img
    ...
    alt="카카오페이 후원 QR 코드">
  <br>
  <sub>📱 카카오톡 앱에서 QR 코드를 스캔하여 후원하실 수 있습니다.</sub>
</p>
...
분석 글이 도움이 되었다고 생각하신다면 커피나 음료 한 잔 정도의 작은 응원도 앞으로 분석 활동을 계속하는 데 도움이 됩니다.

후원 여부와 관계없이 일반적인 보안 분석 글과 기술 정보는 계속 공개할 예정입니다.
